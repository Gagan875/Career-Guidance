        ...
        <div className="lg:col-span-2">
          <div className="card mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link to="/quiz" className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary-500 hover:bg-primary-50 transition-colors">
                <div className="text-center">
                  ...
                  <h3 className="font-medium">Take Career Quiz</h3>
                  <p className="text-sm text-gray-600 mt-1">Discover your ideal career path</p>
                </div>
              </Link>

              <Link to="/colleges" className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-primary-500 hover:bg-primary-50 transition-colors">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-1">Find nearby government colleges</p>
                </div>
              </Link>
            </div>
          </div>
